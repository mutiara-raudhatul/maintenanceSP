                    ...
                    <section class="panel">
							...
							<div class="panel-body">
								<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
									...
									@for($i=0; $i<$jumlah; $i++)
										<tr class="gradeX">
                                            <td>{!!substr(json_encode($modelnya[$i]),1,-1)!!}</td>
											<td class="center">{!!json_encode($jumlah_model[$i])!!}</td>
											<th class="center">
												<a href="{{url('data-detail-barang', $idmodelnya[$i])}}"> <button type="button" class="mb-xs mt-xs mr-xs btn btn-sm btn-success">Detail</button> </a>
							                </th>
										</tr>
									@endfor

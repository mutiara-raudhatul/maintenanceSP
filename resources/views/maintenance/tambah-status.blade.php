...
@section('title', 'Tambah Status Maintenance')
            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h2 class="panel-title">Tambah Status Maintenance</h2>
                    </header>
                    <form class="form-horizontal form-bordered" action="{{route('simpan-statusM')}}" method="post">
                    {{ csrf_field()}}

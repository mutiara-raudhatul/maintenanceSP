...
use App\Http\Controllers\DetailPermintaanBarangController;
...
Route::group(['middleware' => ['auth', 'checkrole:admin_gudang']], function(){
    ...
    //-------DETAIL PERMINTAAN----------
    Route::get('/detail-permintaan-barang/{id_permintaan_barang}', [PermintaanBarangController::class, 'indexDetail'])->name('detail-permintaan-barang');
    Route::get('tolak-permintaan-barang/{id_permintaan_barang}/{kode_jenis}', [PermintaanBarangController::class, 'reject']);
    Route::get('pending-permintaan-barang/{id_permintaan_barang}/{kode_jenis}', [PermintaanBarangController::class, 'pending']);
    ...
    // });
    //--------RESPON PERMINTAAN----------
    // Route::get('/list-respon-permintaan',[ResponPermintaanController::class, 'index']); edit new
    // Route::get('/form-respon-permintaan/{id_permintaan_barang}/{kode_jenis}', 'ResponPermintaanController@tampilTambah');
    Route::get('/form-respon-permintaan/{id_permintaan_barang}/{kode_jenis}',[ResponPermintaanController::class, 'getTambah']);
    Route::post('/tambah-respon-permintaan/{id_permintaan_barang}/{kode_jenis}',[ResponPermintaanController::class, 'setTambah']);
    ...
    Route::get('/detail-respon-permintaan/{id_respon_permintaan}',[DetailPermintaanBarangController::class, 'indexDetail']);
    
      //-------- DETAIL PERMINTAAN BARANG NEW----------
      Route::get('/list-respon-permintaan',[DetailPermintaanBarangController::class, 'index']);
...
Route::group(['middleware' => ['auth', 'checkrole:karyawan,teknisi']], function(){
     ...
     // Route::get('/detail-permintaan-barang-user/{id_permintaan_barang}', [DetailPermintaanUserController::class, 'index']);
     Route::get('/detail-permintaan-barang-user/{id_permintaan_barang}', [PermintaanBarangUserController::class, 'indexDetail']);
         //--------RESPON PERMINTAAN----------
     // Route::get('/list-respon-permintaan-user',[ResponPermintaanController::class, 'indexUser']);
     Route::get('/detail-respon-permintaan-user/{id_permintaan_barang}',[DetailPermintaanBarangController::class, 'indexDetailUser']);
 
      //--------DETAIL PERMINTAAN BARANG USER NEW RESPON----------
     Route::get('/list-respon-permintaan-user',[DetailPermintaanBarangController::class, 'indexUser']);

...
Route::group(['middleware' => ['auth', 'checkRole:admin gudang']], function(){
...
Route::get('/history-admingudang', 'App\Http\Controllers\HistoriController@indexAG')->name('history-admingudang')-> middleware('auth');
